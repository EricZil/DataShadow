    ...
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-[#0A0E17] via-[#0F1419] to-[#0A0E17]">
      ...
      <main className="flex-1 py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="container mx-auto max-w-5xl relative z-10">
          ...
          {/* Contact Section */}
          <div className="bg-gradient-to-br from-[#1A1F2E]/80 to-[#1F2433]/80 rounded-xl border border-gray-800/50 p-8 text-center backdrop-blur-sm shadow-lg relative overflow-hidden animate-fade-in" style={{animationDelay: '500ms'}}>
            {/* Decorative elements */}
            <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/10 rounded-full blur-2xl -mr-16 -mt-16"></div>
            <div className="absolute bottom-0 left-0 w-24 h-24 bg-purple-500/10 rounded-full blur-xl -ml-12 -mb-12"></div>
            ...
            <div className="relative z-10">
              ...
              <h2 className="text-2xl md:text-3xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-blue-200 mb-4">Still have questions?</h2>
              <p className="text-gray-300 mb-8 max-w-2xl mx-auto">
                If you couldn&apos;t find the answer to your question in our FAQ, feel free to reach out to our support team. We&apos;re here to help you protect your digital identity!
              </p>
              <Link 
                href="/contact" 
                className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-500 hover:to-blue-600 text-white rounded-lg transition-all duration-300 shadow-lg hover:shadow-blue-500/25"
              >
                <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
